  ...
  render() {
    return <div>
        ...
        <div className="row">
          ...
          </div> <div className="container col-sm-12 col-md-6">
            <div className="row">
              <div className="col-sm-12 col-md-6">
                <h4> Langues </h4> <p className="pFont">
                  {" "}
                ...
                </h4> <p className="pFont">
                  {" "}
                  Microsoft Windows{" "}
                </p> <p className="pFont"> Linux Ubuntu </p> <br />
              </div> <div className="col-sm-12 col-md-6">
                <h4> Logiciels </h4> <p className="pFont"> Visualcode </p> <p className="pFont">
                  {" "}
                  GitHub{" "}
                </p> <p className="pFont">
                  {" "}
                  Pack Microsoft Office 2016{" "}
                </p> <p className="pFont">
                  {" "}
                  AutoCAD{" "}
                </p> <p className="pFont">
